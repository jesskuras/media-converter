...
function Converter() {
        ...
        "Converter.useEffect": ()=>{
            if (status === "converting") {
                ...
                const interval = setInterval({
                    "Converter.useEffect.interval": ()=>{
                        setProgress({
                            "Converter.useEffect.interval": (prev)=>{
                                const nextVal = prev + Math.floor(Math.random() * 5) + 1;
                                if (nextVal >= 100) {
                                    clearInterval(interval);
                                    setStatus("success");
                                    const dummyBlob = new Blob([
                                        "Simulated MP4 content"
                                    ], {
                                        type: "video/mp4"
                                    });
                ...
                }["Converter.useEffect.interval"], 100);
                return ({
                    "Converter.useEffect": ()=>{
                        clearInterval(interval);
                    }
    ...
    const renderErrorState = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-sm text-muted-foreground",
                    children: "Please select a .webm file."
                }, void 0, false, {
                    fileName: "[project]/src/components/converter.tsx",
                    lineNumber: 180,
                    columnNumber: 9
...
_s(Converter, "PS9bwPHq9fkxaC4WhCmbZskQzcI=", false, function() {
    return [
...
//# sourceMappingURL=_51e50085._.js.map