...
function Converter() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Converter.useEffect": ()=>{
            const loadConverter = {
                "Converter.useEffect.loadConverter": async ()=>{
                    setStatus("loading");
                    try {
                        if (!window.FFmpeg || !window.FFmpegUtil) {
                            const loadScript = {
                                "Converter.useEffect.loadConverter.loadScript": (src)=>new Promise({
                                        "Converter.useEffect.loadConverter.loadScript": (resolve, reject)=>{
                                            const script = document.createElement("script");
                                            script.src = src;
                                            script.onload = ({
                                                "Converter.useEffect.loadConverter.loadScript": ()=>resolve()
                                            })["Converter.useEffect.loadConverter.loadScript"];
                                            script.onerror = ({
                                                "Converter.useEffect.loadConverter.loadScript": ()=>reject(new Error(`Failed to load script: ${src}`))
                                            })["Converter.useEffect.loadConverter.loadScript"];
            ...
            }["Converter.useEffect.loadConverter"];
            loadConverter();
        }
    }["Converter.useEffect"], [
        toast
...
_s(Converter, "zeExNti9ybQmo6wHrC5SrphmWqY=", false, function() {
    return [
...
//# sourceMappingURL=_5cb6408a._.js.map